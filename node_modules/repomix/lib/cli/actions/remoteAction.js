...
export const runRemoteAction = (repoUrl_1, cliOptions_1, ...args_1) => __awaiter(void 0, [repoUrl_1, cliOptions_1, ...args_1], void 0, function* (repoUrl, cliOptions, deps = {
    ...
    try {
        ...
        if (cliOptions.skillGenerate !== undefined) {
            ...
            const promptResult = yield promptSkillLocation(skillName, process.cwd());
        ...
        const optionsWithSkill = Object.assign(Object.assign({}, cliOptions), { skillName, skillDir, skillProjectName, skillSourceUrl });
        result = yield deps.runDefaultAction([tempDirPath], tempDirPath, optionsWithSkill);
        ...
        if (!cliOptions.stdout) {
            if (result.config.skillGenerate !== undefined && skillLocation === 'project') {
                ...
                yield copySkillOutputToCurrentDirectory(tempDirPath, process.cwd());
            }
...
export const copySkillOutputToCurrentDirectory = (sourceDir, targetDir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield fs.access(sourceSkillsDir);
    }
    catch (_a) {
    ...
    try {
        ...
        yield fs.cp(sourceSkillsDir, targetSkillsDir, { recursive: true });
    }
    catch (error) {
        const nodeError = error;
        if (nodeError.code === 'EPERM' || nodeError.code === 'EACCES') {
            throw new RepomixError(`Failed to copy skill output to ${targetSkillsDir}: Permission denied.
...
Please try running from a different directory (e.g., your home directory or Documents folder).`);
        ...
        throw new RepomixError(`Failed to copy skill output: ${error.message}`);
    }
});
