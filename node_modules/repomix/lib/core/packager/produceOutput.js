...
export const produceOutput = (rootDirs_1, config_1, processedFiles_1, allFilePaths_1, gitDiffResult_1, gitLogResult_1, progressCallback_1, ...args_1) => __awaiter(void 0, [rootDirs_1, config_1, processedFiles_1, allFilePaths_1, gitDiffResult_1, gitLogResult_1, progressCallback_1, ...args_1], void 0, function* (rootDirs, config, processedFiles, allFilePaths, gitDiffResult, gitLogResult, progressCallback, overrideDeps = {}) {
    ...
    if (splitMaxBytes !== undefined) {
        return yield generateAndWriteSplitOutput(rootDirs, config, processedFiles, allFilePaths, splitMaxBytes, gitDiffResult, gitLogResult, progressCallback, deps);
    }
    return yield generateAndWriteSingleOutput(rootDirs, config, processedFiles, allFilePaths, gitDiffResult, gitLogResult, progressCallback, deps);
});
const generateAndWriteSplitOutput = (rootDirs, config, processedFiles, allFilePaths, splitMaxBytes, gitDiffResult, gitLogResult, progressCallback, deps) => __awaiter(void 0, void 0, void 0, function* () {
...
const generateAndWriteSingleOutput = (rootDirs, config, processedFiles, allFilePaths, gitDiffResult, gitLogResult, progressCallback, deps) => __awaiter(void 0, void 0, void 0, function* () {
