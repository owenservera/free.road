...
const renderGroups = (groupsToRender, partIndex, rootDirs, baseConfig, gitDiffResult, gitLogResult, generateOutput) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield generateOutput(rootDirs, chunkConfig, chunkProcessedFiles, chunkAllFilePaths, partIndex === 1 ? gitDiffResult : undefined, partIndex === 1 ? gitLogResult : undefined);
});
export const generateSplitOutputParts = (_a) => __awaiter(void 0, [_a], void 0, function* ({ rootDirs, baseConfig, processedFiles, allFilePaths, maxBytesPerPart, gitDiffResult, gitLogResult, progressCallback, deps, }) {
    ...
    for (const group of groups) {
        ...
        const nextContent = yield renderGroups(nextGroups, partIndex, rootDirs, baseConfig, gitDiffResult, gitLogResult, deps.generateOutput);
        ...
        const singleGroupContent = yield renderGroups([group], newPartIndex, rootDirs, baseConfig, gitDiffResult, gitLogResult, deps.generateOutput);
