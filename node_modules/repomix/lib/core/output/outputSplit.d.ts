...
export declare const generateSplitOutputParts: ({ rootDirs, baseConfig, processedFiles, allFilePaths, maxBytesPerPart, gitDiffResult, gitLogResult, progressCallback, deps, }: {
    rootDirs: string[];
...
//# sourceMappingURL=outputSplit.d.ts.map