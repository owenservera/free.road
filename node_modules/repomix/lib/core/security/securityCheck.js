...
export const runSecurityCheck = (rawFiles_1, ...args_1) => __awaiter(void 0, [rawFiles_1, ...args_1], void 0, function* (rawFiles, progressCallback = () => { }, gitDiffResult, gitLogResult, deps = {
    initTaskRunner,
}) {
    const gitDiffTasks = [];
    const gitLogTasks = [];
